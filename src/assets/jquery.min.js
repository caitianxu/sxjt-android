...
jQuery.fn.extend({coord:function(e){if(this.length==0){return param={top:0,left:0,width:0,height:0}}else{var param={};var obj=this.get(0);var param={height:parseInt(obj.clientHeight),width:parseInt(obj.clientWidth),top:0,left:0};do{param.top+=obj.offsetTop||0;param.left+=obj.offsetLeft||0;obj=obj.offsetParent}while(obj);return param}}});